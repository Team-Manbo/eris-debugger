...
const ErisDebugger = require('../')
const codeBlock = require('./codeBlock')
const regexpEscape = require('./regexpEscape')
/**
 * @typedef {ErisDebugger} ErisDebugger
 */
 ...
 * @param {ErisDebugger} erisDebugger
 * @param {ProcessManagerOptions} options
 */
module.exports = class ProcessManager {
    constructor(message, content, erisDebugger, options = {}) {
        this.target = message.channel
        this.erisDebugger = erisDebugger
